...
export default function Superpowers() {
  ...
  return (
    <div className="comic-panel" style={{ padding: "2rem" }}>
      ...
      <p style={{ fontSize: "1rem", marginBottom: "2rem", color: "var(--c-grey-dark)" }}>
      ...
      <div style={{ display: "grid", gap: "1.5rem" }}>
        {skills.map((skill) => (
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px", fontWeight: "bold", alignItems: "center" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                ...
                <span style={{ fontSize: "0.9rem", color: "var(--c-accent)", fontWeight: "bold" }}>
                  {skill.level}%
                </span>
              </div>
            </div>
      ...
      {skills.length === 0 && (
        <div style={{ textAlign: "center", padding: "3rem", color: "var(--c-grey-dark)" }}>
