...
from models import Project, BlogPost, Skill, TimelineEvent, EducationEntry, Award, Tool, Hobby
...
def create_blog_post(post_in: BlogPostCreate, session: Session = Depends(get_session)):
